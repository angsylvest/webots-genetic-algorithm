...
overall_f = open('../../graph-generation/collection-data/overall-ant-info-urban-tmp.csv', 'w') 
overall_f.write('trial' + ',time' + ',objects retrieved' + ',size' + ',type' + '\n')
overall_f.close()
overall_f = open('../../graph-generation/collection-data/overall-ant-info-urban-tmp.csv', 'a') 
...
prev_msg = "" 
seed_val = 11
random.seed(seed_val) # was 11 (changed to 15 to get new configuration) 
