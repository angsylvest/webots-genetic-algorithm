...
def generate_robot_central(num_robots):
    ...
    for i in range(num_robots):
        ...
        rootChildrenField.importMFNode(-1, '../supervisor_controller/robots/robot-levy.wbo') 
