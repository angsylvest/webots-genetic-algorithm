...
overall_f = open('../../graph-generation/collection-data/overall-levy-info-urban-tmp.csv', 'w') 
overall_f.write('trial' + ',time' + ',objects retrieved' + ',size'+ ',type' + '\n')
overall_f.close()
overall_f = open('../../graph-generation/collection-data/overall-levy-info-urban-tmp.csv', 'a') 
